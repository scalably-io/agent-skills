...
The template starts with a `<!-- TEMPLATE_PLACEHOLDER:document-marker -->` HTML comment block. **Delete that comment block as your first edit** — a report that still contains it has not been filled in yet.
