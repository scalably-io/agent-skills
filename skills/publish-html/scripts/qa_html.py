...
HIGH_CONFIDENCE_PLACEHOLDERS: list[str] = [
    "A bold statement or key takeaway that anchors the entire report",
    "A contextual one-liner that bridges the hero",
    "A brief introduction paragraph that sets context",
    "Section heading for a two-column layout",
    "Description of the first concept",
    "Description of the second concept",
    "Description of the third concept",
    "Left column — primary analysis",
    "A pull quote or key insight that deserves emphasis",
    "First key finding or recommendation",
    "First recommended action with expected outcome",
    "Closing headline or call to action",
    "Final sentence — contact info",
    "Replace this with",
    "Video coming soon — send the clip",
    "Lorem ipsum",
    "{{",
    "}}",
    "<%=",
