...
| Category | Examples |
|----------|---------|
| Official documentation | Product docs, API references, release notes, specs |
| Government sources | .gov sites, statistical agencies (BLS, Census, Eurostat) |
| Educational institutions | .edu research pages, university publications |
| Peer-reviewed research | Published journal articles, systematic reviews |
| Established news agencies | Reuters, Bloomberg, AP, BBC, Financial Times, WSJ |
| Industry research firms | Gartner, McKinsey, Forrester, Statista, IDC |
...
| Category | Examples |
|----------|---------|
| Company blogs | Official engineering blogs (Netflix Tech, Uber Eng, Stripe Blog) |
| Tech publications | Ars Technica, The Verge, TechCrunch, InfoQ, The New Stack, Wired |
| Industry blogs | Established blogs with named authors and editorial standards |
| Conference talks | Published talks from recognized conferences with named speakers |
| Preprints | arXiv, SSRN papers from established researchers/institutions |
...
| Category | Examples |
|----------|---------|
| Forums and discussion | Reddit, Hacker News, Stack Overflow, Discord |
| Personal blogs | Medium, dev.to, Substack, personal websites |
| Self-published content | YouTube videos, podcasts (without transcript verification) |
| User-generated wikis | Community wikis, fandom pages |
...
| Quora | Unverified anonymous answers, no editorial standards |
| Unverifiable claims | Any claim without a traceable origin |
